...
# set terminal cairolatex  pdf standalone noheader blacktext nobackground fontscale 0.6 size 5.00in, 3.00in 
# set output
unset clip points
set clip one
unset clip two
...
plot 'Potencial01.dat' w  image , '++' usi ($1):($2):(scaling*efx($1,$2)):(scaling*efy($1,$2))  w vectors head size 0.1,15,60 filled lc "black"
#    EOF
